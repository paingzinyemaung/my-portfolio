          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {repos.map((repo) => {
              ...
              return (
                <div
                  key={repo.id}
                  className="bg-white/70 backdrop-blur-md border border-slate-200 rounded-2xl overflow-hidden shadow-lg shadow-slate-900/5 hover:-translate-y-1.5 hover:border-slate-300 transition-all duration-300 flex flex-col justify-between dark:bg-slate-900/50 dark:border-slate-800/80 dark:shadow-xl dark:shadow-black/20 dark:hover:border-slate-700/80"
                >
                  {/* Card Main Body */}
                  <div className="p-6 flex-1 flex flex-col">
                    <h3 className="text-xl font-bold text-slate-900 mb-2.5 hover:text-blue-600 transition cursor-pointer dark:text-slate-100 dark:hover:text-blue-400">
                      {repo.name}
                    </h3>
                  ...
                  <div className="px-6 py-4 bg-slate-50/70 border-t border-slate-200 flex items-center gap-3 text-xs font-medium dark:bg-slate-950/40 dark:border-slate-800/80">
                    <a
                      ...
                      className="flex-1 py-2 px-3 rounded-lg bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 hover:text-slate-950 transition-all duration-200 flex items-center justify-center gap-2 font-semibold dark:bg-slate-800/60 dark:hover:bg-slate-800 dark:border-slate-700/50 dark:text-slate-300 dark:hover:text-white"
                    >
                    ...
                    {repo.homepage && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 py-2 px-3 rounded-lg bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 hover:text-blue-800 transition-all duration-200 flex items-center justify-center gap-1.5 font-semibold dark:bg-blue-600/20 dark:hover:bg-blue-600/30 dark:border-blue-500/30 dark:text-blue-400 dark:hover:text-blue-300"
                      >
                        <svg
