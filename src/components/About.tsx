    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Philosophy Card */}
          <div className="lg:col-span-5 bg-white/70 border border-slate-200 p-6 rounded-2xl backdrop-blur-md relative group transition-all duration-300 hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-2xl hover:shadow-blue-500/10 dark:bg-slate-900/40 dark:border-slate-800/80 dark:hover:border-blue-500/30 dark:hover:shadow-blue-500/5">
